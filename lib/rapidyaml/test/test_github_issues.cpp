...
L{N(KEYVAL, "audio memory", /*"~"*/{}), N("more", L{N("example", "y")})}
);
        ...
        N("objects", L{
            N("object", L{
                ...
                N("components", L{
                    ...
                    N(L{N("component", L{N("type", "mesh component"), N("data", L{N("mesh memory", "TODO")}), }), }),
                    N(L{N("component", L{N("type", "lua script component"), N(KEYMAP, "data", L{}), }), }),
                    N(L{N("component", L{N("type", "audio component"), N("data", L{N("audio memory", ""), N("type", "0"), N("current sample", "184102"), N("spatialized", "true"), }), }), }), // component
                  }), // components
                N("children", L{
                    N(L{N("object", L{
